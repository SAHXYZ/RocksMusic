...
API_URL = getenv("API_URL", "https://api.nexgenbots.xyz")  # YouTube song API base URL
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/SAHXYZ/RocksMusic",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/ojhkri.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "RocksMusic/assets/ping.mp4"
)
